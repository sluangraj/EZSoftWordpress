...
class EPKB_Welcome_Screen {
	...
	private function show_what_is_new() {   ?>
       ...
       <!-- <div class="eckb-whats-new">
		...
		<div class="row">
			<div class="col-12">
				<h4>3.5.0, July 18, 2018</h4>
				<ul>
					<li>Improved: Ability to change heading on Category Archive Page</li>
					<li>Improved: Added paging to KB Template - Category Archive page</li>
					<li>Improved: Ensure all text is ready for translation</li>
					<li>Fix: Handle articles that are in future, draft or pending</li>

...
class EPKB_KB_Config_Page {
	...
	public function display_mega_menu() {
		...
		$this->mega_menu_item_custom_html_content( array(
			...
			'sections'  => array(
				array(
					'heading' => __( '1. Layout', 'echo-knowledge-base' ),
					'form_elements' => array(
						array(
				...
				array(
					'heading' => __( '2. Style', 'echo-knowledge-base' ),
					'form_elements' => array(
                        array(
				...
				array(
					'heading' => __( '3. Colors', 'echo-knowledge-base' ),
					'form_elements' => array(
						array(
                ...
                array(
                    'heading' => __( '4. Template', 'echo-knowledge-base' ),
                    'form_elements' => array(
                        array(
		...
		$this->mega_menu_item_custom_html_content( array(
			...
			'sections'  => array(
                array(
                    'heading' => __( '4. Organize', 'echo-knowledge-base' ),
                    'links' => array(),
                    'form_elements' => array(
                        array(
		...
		$this->mega_menu_item_content( array(
			...
			'sections'  => array(
				array(
					'heading' => __( 'Text', 'echo-knowledge-base' ),
					'links' => array( __( 'Search Box', 'echo-knowledge-base' ), __( 'Categories', 'echo-knowledge-base' ), __( 'Articles', 'echo-knowledge-base' ) )
				),
			)
		));
        ...
        $this->mega_menu_item_content( array(
            ...
            'sections'  => array(
                array(
	                'heading' => __( 'Search Box', 'echo-knowledge-base' ),
	                'links' => array( __( 'Layout', 'echo-knowledge-base' ), __( 'Colors', 'echo-knowledge-base' ), __( 'Text', 'echo-knowledge-base' ), __( 'Advanced', 'echo-knowledge-base' ) )
                ),
                array(
	                'heading' => __( 'Content', 'echo-knowledge-base' ),
	                'links' => ( $main_page_sbl ? array( __( 'Style', 'echo-knowledge-base' ), __( 'Colors', 'echo-knowledge-base' ), __( 'Text', 'echo-knowledge-base' ) )
		                                        : array( __( 'Style', 'echo-knowledge-base' ), __( 'Colors', 'echo-knowledge-base' ) ) ),
                ),
                array(
	                'heading' => __( 'List of Articles', 'echo-knowledge-base' ),
                    'exclude' => $grid_layout,
	                'links' => array( __( 'Style', 'echo-knowledge-base' ), __( 'Colors', 'echo-knowledge-base' ), __( 'Text', 'echo-knowledge-base' ), __( 'Advanced', 'echo-knowledge-base' ) )
                ),
                array(
	                'heading' => __( 'Categories', 'echo-knowledge-base' ),
	                'links' => array( __( 'Style', 'echo-knowledge-base' ), __( 'Colors', 'echo-knowledge-base' ), __( 'Text', 'echo-knowledge-base' ), __( 'Advanced', 'echo-knowledge-base' ) )
                ),
            )
        ));
		...
		if ( $article_page_with_config_layout ) {
	        ...
	        $this->mega_menu_item_custom_html_content( array(
		        ...
		        'sections'  => array(
			        array(
				        'heading' => __( 'Layout', 'echo-knowledge-base' ),
				        'form_elements' => array(
					        array(
						        'id'   => 'mega-menu-article-page-layout',
						        'html' => $this->form->radio_buttons_vertical( array('options' => $article_page_layouts, 'label' => '') +
		...
		if ( $this->kb_article_page_layout != EPKB_KB_Config_Layouts::KB_ARTICLE_PAGE_NO_LAYOUT ) {
			$this->mega_menu_item_custom_html_content( array(
				...
				'sections' => array(
					array(
						'heading'       => __( 'Organize', 'echo-knowledge-base' ),
						'links'         => array(),
						'form_elements' => array(
							array(
        ...
        $this->mega_menu_item_content( array(
            ...
            'sections'  => array(
                array(
                    'heading' => __( 'Features', 'echo-knowledge-base' ),
                    'links' => array( __( 'Back Navigation', 'echo-knowledge-base' ), __( 'Comments', 'echo-knowledge-base' ), __( 'Breadcrumb', 'echo-knowledge-base' ), __( 'Other', 'echo-knowledge-base' ) )
                ),
            )
        ));
        ...
        if ( $article_page_with_config_layout ) {
            $this->mega_menu_item_content( array(
                ...
                'sections'  => array(
                    ...
                    array(
                        'heading' => __( 'Content', 'echo-knowledge-base' ),
                        'links' => array( __( 'Style', 'echo-knowledge-base' ), __( 'Colors', 'echo-knowledge-base' ) )
                    ),
                    array(
                        'heading' => __( 'Categories', 'echo-knowledge-base' ),
                        'links' => array( __( 'Style', 'echo-knowledge-base' ), __( 'Colors', 'echo-knowledge-base' ), __( 'Text', 'echo-knowledge-base' ), __( 'Advanced', 'echo-knowledge-base' ) )
                    ...
                    array(
                        'heading' => __( 'Article Common Path', 'echo-knowledge-base' ),
                        'links' => array( __( 'Configuration', 'echo-knowledge-base' ) )
                    ),
                )
            ));
        } else {
		...
		echo '<div class="epkb-archive-page-template-config">';
			...
			$this->mega_menu_item_custom_html_content( array(
				...
				'sections'  => array(
					array(
						'heading' => __( 'Layout Style', 'echo-knowledge-base' ),
						'form_elements' => array(
							array(
	...
	public function get_main_page_order_form() {
		...
		<div class="epkb-config-sidebar" id="epkb-config-ordering-sidebar" hidden>
            ...
            $this->form->option_group( $this->feature_specs, array(
                'option-heading'    => __( 'Organize Categories and Articles', 'echo-knowledge-base' ),
        ...
        <div class="epkb-config-sidebar" id="epkb-config-article-template-sidebar">
            <div class="epkb-config-sidebar-options">                <?php
                ...
                $form->option_group( $feature_specs, array(
	                ...
	                'option-heading'    => __( 'Article Template', 'echo-knowledge-base' ),
        ...
        <div class="epkb-config-sidebar" id="epkb-config-article-features-sidebar">
            <div class="epkb-config-sidebar-options">                        <?php
                ...
                $form->option_group( $feature_specs, array(
                    ...
                    'option-heading'    => __( 'Back Navigation - Advanced', 'echo-knowledge-base' ),
                    'class'             => 'eckb-mm-ap-links-features-features-backnavigation',
                    'inputs'            => array(
	                    '0' => $form->multiple_number_inputs(
		                    array(
	            ...
	            $form->option_group( $feature_specs, array(
                    ...
                    'option-heading'    => __( 'Breadcrumb - Advanced', 'echo-knowledge-base' ),
                    'class'             => 'eckb-mm-ap-links-features-features-breadcrumb',
                    'inputs'            => array(
	            ...
	            $form->option_group( $feature_specs, array(
		            ...
		            'option-heading'    => __( 'Other', 'echo-knowledge-base' ),
                ...
                /* $form->option_group( $feature_specs, array(
                    ...
                    'option-heading'    => __( 'Tags', 'echo-knowledge-base' ),
	...
	public function display_articles_common_path() {
		...
		$this->form->option_group( $this->feature_specs, array(
			'option-heading'    => __( 'Article Path', 'echo-knowledge-base' ) . ' ( URL )',
				...
				foreach( $kb_main_pages_info as $post_id => $post_info ) {
                   ...
                   /* if ( 'page' == get_option( 'show_on_front' ) && $first_page_id = get_option( 'page_on_front' ) ) {
					...
					$label = site_url() . '/<strong><a href="' . get_edit_post_link( $post_id ) . '" target="_blank">' . esc_attr($kb_home_slug) . "</a></strong>" .
                             ( empty($kb_home_slug) ? '' : '/' ) . '<span style="font-style:italic;">' . __( 'KB-article-slug', 'echo-knowledge-base' ) . '</span>';    			?>
